    ...
    <div>
      ...
      <Container>
        <Grid container alignItems="center" spacing={2}>
          ...
          <Grid item xs={6} md={3}>
            <Link to={`/medicines-page/:cardiac-care`}>
              <Cards
                title="Cardiac Care"
          ...
          <Grid item xs={6} md={3}>
            <Link to={`/medicines-page/:skin-care`}>
              <Cards
                title="Skin Care"
          ...
          <Grid item xs={6} md={3}>
            <Link to={`/medicines-page/:hair-care`}>
              <Cards
                title="Hair Care"
          ...
          <Grid item xs={6} md={3}>
            <Link to={`/medicines-page/:stomach-care`}>
              <Cards
                title="Stomach Care"
          ...
          <Grid item xs={6} md={3}>
            <Link to={`/medicines-page/:ortho-care`}>
              <Cards
                title="Ortho Care"
          ...
          <Grid item xs={6} md={3}>
            <Link to={`/medicines-page/:eye-care`}>
              <Cards
                title="Eye Care"
          ...
          <Grid item xs={6} md={3}>
            <Link to={`/medicines-page/:health-care`}>
              <Cards
                title="Health Care"
                src="https://cardiacsolutions.net/blog/wp-content/uploads/2017/10/cardiac_red_heart.jpg"
              />
